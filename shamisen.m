...
%         2*uS(lS1c-1)/3 + uS(lS1c-2)/6)*kappaS^2 * k^2)/2));
    ...
    Fs1b = FsbMult * (uB(lBc1)*uBlMult + (uB(lBc1-1) + uB(lBc1+1))*uBl1Mult + (uB(lBc1-2) + uB(lBc1+2))*uBl2Mult + ...
    ...
    Fs2b = FsbMult * (uB(lBc2)*uBlMult + (uB(lBc2-1) + uB(lBc2+1))*uBl1Mult + (uB(lBc2-2) + uB(lBc2+2))*uBl2Mult + ...
    ...
    Fs3b = FsbMult * (uB(lBc3)*uBlMult + (uB(lBc3-1) + uB(lBc3+1))*uBl1Mult + (uB(lBc3-2) + uB(lBc3+2))*uBl2Mult + ...
